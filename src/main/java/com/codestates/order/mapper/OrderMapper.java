...
public interface OrderMapper {
    ...
    default OrderResponseDto orderToOrderResponseDto(Order order){
        ...
        orderResponseDto.setOrderCoffees(orderCoffeesToOrderCoffeeResponseDto(orderCoffees));
        return orderResponseDto;
    }

    default List<OrderCoffeeResponseDto> orderCoffeesToOrderCoffeeResponseDto(List<OrderCoffee> orderCoffees){
        return orderCoffees
                .stream()
